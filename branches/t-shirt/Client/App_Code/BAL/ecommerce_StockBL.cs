...
{
    public ecommerce_StockBL(int stock_id, int stock_Value, int fkSize_id, int fkColor_id, int fkProduct_id, decimal price, string stock_Image)
	{
    ...
    public ecommerce_StockBL(int stock_Value, int fkSize_id, int fkColor_id, int fkProduct_id, decimal price, string stock_Image)
    {
        this.Stock_Value = stock_Value;
        this.FkSize_id = fkSize_id;
        this.FkColor_id = fkColor_id;
