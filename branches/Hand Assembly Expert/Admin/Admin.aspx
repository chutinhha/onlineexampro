                        ...
                        <tr>
                            ...
                            <td valign="top" width="50%">
                                <table>
                                    <tr>
                                        <td>
                                            <asp:GridView ID="gvImageSlider" runat="server" AutoGenerateColumns="False" Height="118px"
                                                Width="250px" AutoGenerateDeleteButton="True" OnRowDeleting="gvImageSlider_RowDeleting">
                                                <Columns>
                                                    <asp:TemplateField>
                                                        <ItemTemplate>
