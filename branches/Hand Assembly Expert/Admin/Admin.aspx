                        ...
                        <tr>
                            ...
                            <td valign="top">
                                <table>
                                    <tr>
                                        <td>
                                            <asp:GridView ID="gvServiceList" runat="server" AutoGenerateColumns="false" Width="250px"
                                                OnRowDeleting="gvServiceList_RowDeleting">
                                                <Columns>
                                                    <asp:TemplateField>
                                                        <ItemTemplate>
                                                            <asp:LinkButton ID="lbtnDeleteTitle" runat="server" CommandName="Delete">Delete</asp:LinkButton>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
