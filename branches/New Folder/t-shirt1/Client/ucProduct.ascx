...
<asp:Panel ID="Panel1" runat="server" Width="350px" BackColor="#333333">
    <table cellpadding="2" cellspacing="2" width="350">
        <tr class="productHeadingfont">
            <td>
                &nbsp;&nbsp;&nbsp;&nbsp; Infiniti trend Wear for&nbsp;<asp:Label ID="lbGenter" runat="server"
                                    ...
                                    <td>
                                        <table cellpadding="0" cellspacing="0" width="100%">
                                            <tr>
                                                ...
                                                <td class="productDetailfont" id="stockvalidation" runat="server">
                                ...
                                <tr>
                                    <td align="right">
                                        <table>
                                            <tr>
                                                <td>
                                                    <asp:LinkButton CssClass="buynow" ID="lbWishList" CommandArgument='<%#Eval("stock_id")%>'
                                                        runat="server" Text="WishList" OnClick="lbWishList_Click"></asp:LinkButton>
                                                </td>
                                                <td>&nbsp;&nbsp;&nbsp;</td>
                                                <td>
