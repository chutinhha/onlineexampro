<%@ Page Title="" Language="C#" MasterPageFile="~/Payroll.master" AutoEventWireup="true"
    CodeFile="Personal.aspx.cs" Inherits="Personal" %>
                ...
                <tr>
                    <td>
                                                    ...
                                                    <table cellpadding="0" cellspacing="0">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <cc1:AsyncFileUpload ID="fuPhoto" runat="server" OnUploadedComplete="fuPhoto_UploadedComplete" />
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td style="padding-top: 5px">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <cc1:AsyncFileUpload ID="fuIProof" runat="server" OnUploadedComplete="fuIProof_UploadedComplete" />
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td style="padding-top: 5px">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <cc1:AsyncFileUpload ID="fuAProof" runat="server" OnUploadedComplete="fuAProof_UploadedComplete" />
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                        ...
                        <cc1:CollapsiblePanelExtender ID="CollapsiblePanelExtender1" runat="server" TargetControlID="pBody"
                            ...
                            ExpandedImage="Images/DownArrow.png" CollapsedImage="Images/UpArrow.png" CollapsedSize="0">
                                                    ...
                                                    <table cellpadding="0" cellspacing="0">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <cc1:AsyncFileUpload ID="fuResume" runat="server" OnUploadedComplete="fuResume_UploadedComplete" />
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td style="padding-top: 5px">
