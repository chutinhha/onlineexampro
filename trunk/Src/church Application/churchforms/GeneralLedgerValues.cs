...
namespace churchforms
{
    public partial class GeneralLedgerValues : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            //{
            //  //  System.Nullable<decimal> harvest1 = 0;
            //    //churchDB.sp_Church_HarvestAmount(Convert.ToDateTime(dateTimePicker2.Text), Convert.ToDateTime(dateTimePicker3.Text), ref harvest1);
            ...
            //  //  label33.Text = Convert.ToString(harvest1);
