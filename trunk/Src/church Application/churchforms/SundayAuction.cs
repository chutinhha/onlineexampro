                ...
                using (ChurchApplicationDataContext churchDB = new ChurchApplicationDataContext())
                {
                    ...
                    if (checkBox2.Checked || checkBox1.Checked)
                    {
                        ...
                        if (num.Count() == 0)
                        {
                            ...
                            status.Sunday_Action_Payed = Convert.ToDecimal(txtCashamount.Text)+Convert.ToDecimal(txtChequeAmount.Text);
                        ...
                        else
                        {
                            ...
                            num1.Sunday_Action_Payed = num1.Sunday_Action_Payed + Convert.ToDecimal(txtCashamount.Text)+Convert.ToDecimal(txtChequeAmount.Text);
                            churchDB.SubmitChanges();
                        }
