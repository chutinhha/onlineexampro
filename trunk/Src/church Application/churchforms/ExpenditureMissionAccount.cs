...
{
    public partial class ExpenditureMissionAccount : Form
    {
        public ExpenditureMissionAccount()
        {
            InitializeComponent();
        }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            using (ChurchApplicationDataContext obj = new ChurchApplicationDataContext())
            {
                ...
                {
                    var single = from a in obj.Church_MissionExpenditureType_Details where a.MissionExpenditure_Name == "Others" select a;
                    obj.Church_MissionExpenditureType_Details.DeleteOnSubmit(single.SingleOrDefault());
                    obj.SubmitChanges();
                    Church_MissionExpenditureType_Detail church = new Church_MissionExpenditureType_Detail();
                    church.MissionExpenditure_Name = textBox2.Text;
                    obj.Church_MissionExpenditureType_Details.InsertOnSubmit(church);
                    obj.SubmitChanges();
                    Church_MissionExpenditureType_Detail church1 = new Church_MissionExpenditureType_Detail();
                    church1.MissionExpenditure_Name = "Others";
                    obj.Church_MissionExpenditureType_Details.InsertOnSubmit(church1);
                    obj.SubmitChanges();
                    comboBox1.DataSource = from a in obj.Church_MissionExpenditureType_Details select a;
                    comboBox1.DisplayMember = "MissionExpenditure_Name";
                    comboBox1.ValueMember = "MissionExprnditure_Id";
