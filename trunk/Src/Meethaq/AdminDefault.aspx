<%@ Page Language="C#" AutoEventWireup="false" Inherits="DotNetNuke.Framework.DefaultPage" CodeFile="AdminDefault.aspx.cs" %>
...
<head id="Head" runat="server">
  ...
  <script>
      $('#siteHeadouter').css('display', 'none');
      $('#contentWrapper').css('display', 'none');
  </script>
</head>
<body id="Body" runat="server" style="background-image: url('http://localhost:38631/Portals/_default/Skins/Gravity/Images/pattern-bg.png');margin:0px;font-family:Arial;font-size:12px;line-height:1.5em; border:0px;padding:0px;background-color:#ffffff;background-repeat:repeat;">    
