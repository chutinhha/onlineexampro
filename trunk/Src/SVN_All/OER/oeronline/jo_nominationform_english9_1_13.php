...
<tr>
										...
										<p style="margin: 10px 20px">
										<span style="color:#F00;">*</span><input type="text" size="30" tabindex="1" name="name" value="<?php echo $_SESSION['form_val']['name']; ?>"></p></td>
									</tr>
                                    <tr>
										<td width="11">&nbsp;</td>
										<td width="204" bgcolor="#FFFFFF">
								      ...
								      Surname:</font></p></td>
										...
										<td width="289" bgcolor="#FFFFFF">
										<p style="margin: 10px 20px">
										<span style="color:#F00;">*</span><input type="text" value="<?php echo $_SESSION['form_val']['surname']; ?>" size="30" tabindex="2" name="surname"></p></td>
									</tr>
                                    </table>
                                    ...
                                    <tr>
										...
										<td width="289" bgcolor="#FFFFFF">
										<p style="margin: 10px 20px">
										<span style="color:#F00;">*</span><input type="text" value="<?php echo $_SESSION['form_val']['mobile']; ?>" size="30" tabindex="3" name="mobile"></p></td>
									</tr>
                                    <tr>
										<td width="11">&nbsp;</td>
										<td width="204" bgcolor="#FFFFFF">
										...
										<td width="289" bgcolor="#FFFFFF">
										<p style="margin: 10px 20px">
										<span style="color:#F00;">&nbsp;</span><input type="text" value="<?php echo $_SESSION['form_val']['landLine']; ?>" size="30" tabindex="4" name="landLine"></p></td>
									</tr>
                                    <tr>
										<td width="11">&nbsp;</td>
										<td width="204" bgcolor="#FFFFFF">
										...
										<td width="289" bgcolor="#FFFFFF">
										<p style="margin: 10px 20px">
										<span style="color:#F00;">*</span><input type="text" value="<?php echo $_SESSION['form_val']['mail']; ?>" size="30" tabindex="5" name="mail"></p></td>
									</tr>
                                    <tr>
										<td width="11">&nbsp;</td>
										<td width="204" bgcolor="#FFFFFF">
										<p style="margin: 10px 20px">
										<em><font face="Verdana" color="#4D555B" size="1" style="font-weight:bold;">
									  Nominated By:</font></em></p></td>
										<td width="44" bgcolor="#FFFFFF">
										<p style="margin: 10px 20px">&nbsp;</p></td>
										<td width="289" bgcolor="#FFFFFF">
										<p style="margin: 10px 20px">
										<span style="color:#F00;">*</span><input type="text" value="<?php echo $_SESSION['form_val']['nominated']; ?>" size="30" tabindex="6" name="nominated"></p></td>
									</tr>
                                    <tr>
										<td width="11">&nbsp;</td>
										<td width="204" bgcolor="#FFFFFF">
										...
										<td width="289" bgcolor="#FFFFFF">
										<p style="margin: 10px 20px">
										<span style="color:#F00;">*</span><input type="text" value="<?php echo $_SESSION['form_val']['nomMob']; ?>" size="30" tabindex="7" name="nomMob"></p></td>
									</tr>
                                    <tr>
										<td width="11">&nbsp;</td>
										<td width="204" bgcolor="#FFFFFF">
										...
										<td width="289" bgcolor="#FFFFFF">
										<p style="margin: 10px 20px">
										<span style="color:#F00;">*</span><input type="text" value="<?php echo $_SESSION['form_val']['nomMail']; ?>" size="30" tabindex="8" name="nomMail"></p></td>
									</tr>
</table>
<br />
