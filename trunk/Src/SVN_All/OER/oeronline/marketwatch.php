...
<body topmargin="0" leftmargin="0" rightmargin="0" style="font-family:Verdana, Arial, Helvetica, sans-serif;">
...
<table border="0" cellpadding="0" cellspacing="0" width="100%" style="border-collapse: collapse" bordercolor="#111111">
	<tr>
					...
					<?php
					  $aquery	= "SELECT * FROM `".TB_HEADLISTS."` Where Auto_mnth='".$m."' AND Auto_year='".$y."' AND publish=1 AND Category='21' ORDER BY Auto_id ASC";
	...
	<tr class="<?php echo $class ?>">
						<td valign="top" width="65%" <?php if($getauto['Auto_img']==""){ echo 'colspan="2"';}?>>
						<div align="justify" class="style10" style="line-height: 14px"><?php echo $getauto['Auto_desc']; ?></div>
</td>
<?php
						if($getauto['Auto_img']!=""){
						?>
