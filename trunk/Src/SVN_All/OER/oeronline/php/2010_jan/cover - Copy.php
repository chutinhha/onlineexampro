...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
	<tr>
		        <td valign="top" width="100%"> <p align="justify" style="margin-left: 10px; margin-right: 10px"> 
                    <b><font face="Verdana" size="2"><br>
                    </font></b><font size="2" face="Verdana"><b>Striking the right 
                    note<br>
                    ...
                    by Visvas Paul D Karra</font></b></p>
				  <p align="justify" style="margin-left: 10px; margin-right: 10px"> 
					...
					car-wash, fearing the crackdown on illegal expat workers.<br>
					<br>
					...
					rials extra and they decided to jump ship and resigned.<br>
					<br>
					...
					entrepreneurships as well.<br>
&nbsp;</font><font size="1" face="Verdana, Arial, Helvetica, sans-serif"><hr width="98%" size="1">
					</font>
				<p align="justify" style="margin-left: 10px; margin-right: 10px"> 
                    <font size="1" face="Verdana, Arial, Helvetica, sans-serif"> 
                  <b>Razor thin edge</b><br>
                  <br>
                  ...
                  nation. The same holds true for Oman as well. <br>
                  <br>
                  ...
                  end of 2009 to comply with all the Omanisation targets.|<br>
                  <br>
                  ...
                  workers. This has shaken up the private sector.<br>
                  <br>
                  <hr width="98%" size="1">
                  <p style="margin-left: 10px; margin-right: 10px" align="justify"> 
                    <b> Black economy<br>
                    <br>
                    Eric cLean , Chief Development Officer<br>
                    </b><font color="#CC3333"><em>The Zubair Corporation<br>
                    </em></font><br>
                    <b> <img src="images/cover_img2_jan2010.jpg" width="200" height="142" hspace="9" vspace="5" border="0" align="right"></b>Eric 
                    ...
                    promising Omanis within the group companies.</p>
                  <hr width="98%" size="1">
                  <p style="margin-left: 10px; margin-right: 10px" align="justify"> 
                    <b>Create, regularise, develop<br>
                    </b><br>
                    ...
                    and develop the national manpower.<br>
                    <br>
                    ...
                    being thrown out with the bathwater”.<br>
                    <br>
				...
				<b> <font size="1" face="Verdana, Arial, Helvetica, sans-serif"> 
                    Mohammed Al Kharusi, Director<br>
                    </font></b><font color="#CC3333" size="1" face="Verdana, Arial, Helvetica, sans-serif"><em>Human 
                    Resources and Information Technology, MB Holding Company </em></font>
					<font size="1" face="Verdana, Arial, Helvetica, sans-serif">
					<br>
					<br>
					<img src="images/cover_img1_jan2010.jpg" width="200" height="191" hspace="9" vspace="5" border="0" align="left">“Meeting the new and higher Omanisation targets in the oil 
					and gas industry is certainly not an easy matter as we are a 
					highly Omanised sector. It takes time to fill the higher 
					level positions and the specialised ones. We are 78 per cent 
					Omanised in the oil services category. We need more time, 
					apart from the grace period already granted to us, to 
					implement the targets because of two reasons. Firstly, the 
					ministry of manpower job codes for the oil and gas industry 
					is not complete and we would urge the Ministry to work with 
					the industry and update the list and it is difficult to get 
					the exact qualified person for a particular job code 
					particularly for specialists who do not fit any of the job 
					codes. The second point is our sub-contractors who employ 
					people on free (Azad) visas. We have requested them (the 
					contractors) to remove the illegal casual workers. In cases 
					where these sub-contractors are not complying with our 
					demands, we are terminating the contract itself,” says 
					Mohammed Al Kharusi, Director, Human Resources and 
					Information Technology, MB Holding Company, whose flagship 
					group company is MB Petroleum Services. Around 5,000 people 
					work in Oman for MB Holding.<br>
					<br>
					<b><br>
					&nbsp;</b></font></p>
                    <font size="1" face="Verdana, Arial, Helvetica, sans-serif">
				...
				<font size="1" face="Verdana, Arial, Helvetica, sans-serif">
					<b>Whither skills?<br>
					<br>
					Aqeel Jawad Sultan ,Group Managing Director<br>
					</b><font color="#CC3333"><em>Jawad Sultan Enterprises</em></font><b><br>
					</b><br>
					<img src="images/cover_img5_jan2010.jpg" hspace="9" vspace="5" border="0" align="left">Kharusi points out that the oil and gas sector needs workers 
					...
					takes training and time to gain the experience. <br>
					<br>
					...
					Sultan Technologies, the leading telecom company of Oman.<br>
					<br>
					...
					Commerce and Industry (OCCI).</font></p>
                    <font size="1" face="Verdana, Arial, Helvetica, sans-serif">
					<hr width="98%" size="1">
					</font>
				<p style="margin-left: 10px; margin-right: 10px" align="justify">
				<font size="1" face="Verdana, Arial, Helvetica, sans-serif">
					<b>Conflicting pressures<br>
				</b><br>
					<b>Aqeel A Munam Sulaiman , CEO</b><br>
				<font color="#CC3333"><em>Salmancorporation</em></font><b><br>
				<br>
					<img src="images/cover_img6_jan2010.jpg" hspace="9" vspace="5" border="0" align="right"></b>Human resource experts admit that there are conflicting 
					...
					develop staff and contribute more to a local workforce.<br>
					<br>
					...
					if they are unable to hire temporary/ casual labourers. <br>
					<br>
					...
					they have peak times and non-peak times.<br>
					<br>
					...
					Coffee, Pizza Inn, Foto Magic, City Watch, etc.</font></p>
                    <font size="1" face="Verdana, Arial, Helvetica, sans-serif">
					<hr width="98%" size="1">
					</font>
				<p style="margin-left: 10px; margin-right: 10px" align="justify">
				<font size="1" face="Verdana, Arial, Helvetica, sans-serif">
					<b>Working woes<br>
					<br>
					Salim Al Kaabi, Assistant General <br>
					</b><font color="#CC3333"><em>Manager – HR, BankMuscat</em></font><b><br>
					</b><br>
					<img src="images/cover_img3_jan2010.jpg" width="200" height="192" hspace="9" vspace="5" border="0" align="left">Talking 
					...
					the weekends. So who will drive the cars?<br>
					<br>
					...
					Omani is employed to be only a cashier, points out Sulaiman.<br>
					<br>
					...
					objective of nationalisation of human resources, adds Kaabi.</font></p>
                    <font size="1" face="Verdana, Arial, Helvetica, sans-serif">
					<hr width="98%" size="1">
					</font>
				<p style="margin-left: 10px; margin-right: 10px" align="justify">
				<font size="1" face="Verdana, Arial, Helvetica, sans-serif">
					...
					masons, tile layers, painters, electricians etc. <br>
					<br>
					...
					such as steel and cement, rose from 140 rials to 160 rials.</font></p>
                    <font size="1" face="Verdana, Arial, Helvetica, sans-serif">
					<hr width="98%" size="1">
					</font>
				<p style="margin-left: 10px; margin-right: 10px" align="justify">
				<font size="1" face="Verdana, Arial, Helvetica, sans-serif">
					<b>Intention to abscond<br>
				<br>
				Hans Erlings, CEO<br>
				</b><font color="#CC3333"><em>Galfar Engineering &amp; Contracting</em></font><b><br>
				</b><br>
					<b>
					<img src="images/cover_img8_jan2010.jpg" width="200" height="224" hspace="9" vspace="5" border="0" align="right"></b>Hans Erlings, CEO, Galfar Engineering &amp; Contracting, is all 
					...
					with a turnover of over $1bn and has over 27,000 employees.<br>
					<br>
				...
				<font size="1" face="Verdana, Arial, Helvetica, sans-serif">
					<b>Freely illegal!<br>
					<br>
					P M Jabir, Secretary<br>
					</b><font color="#CC3333"><em>Community Welfare, Indian 
					Social Club, Muscat</em></font><b><br>
					</b><br>
					<b>
				<img src="images/cover_img4_jan2010.jpg" width="200" height="198" hspace="9" vspace="5" border="0" align="left"></b>According to rough estimates there are about 120,000 Indian 
					...
					Indian Social Club in Muscat.<br>
					<br>
					...
					Salaam Insurance as a general manager.<br>
					<br>
					...
					amended labour law by the authorities.</font></p>
                    <font size="1" face="Verdana, Arial, Helvetica, sans-serif">
					<hr width="98%" size="1">
					</font>
				<p style="margin-left: 10px; margin-right: 10px" align="justify">
				<font size="1" face="Verdana, Arial, Helvetica, sans-serif">
					<b>Curbing exploitation<br>
				</b><br>
					...
					collect monthly ‘fees’ from the latter.<br>
					<br>
					...
					abscond and become illegal.</font></p>
                    <font size="1" face="Verdana, Arial, Helvetica, sans-serif">
					<hr width="98%" size="1">
					</font>
				<p style="margin-left: 10px; margin-right: 10px" align="justify">
				<font size="1" face="Verdana, Arial, Helvetica, sans-serif">
					<b>Plan and progress<br>
				<br>
				Gorvinder Pannu , Labour Law <br>
				</b><font color="#CC3333"><em>Specialist, Trowers Hamlins</em></font><b><br>
				<br>
				</b><br>
					<img src="images/cover_img7_jan2010.jpg" width="200" height="250" hspace="9" vspace="5" border="0" align="left">Long term planning is another way to reduce the impact of 
					...
					make a business case to prove this. In my personal opinion 
					there is scope for development of the Omani labour law to 
					accommodate casual/ temporary employees in companies.”<br>
					<br>
					...
					law of the land. </font></p>
                    <font size="1" face="Verdana, Arial, Helvetica, sans-serif">
					<hr width="98%" size="1">
					</font>
				<p style="margin-left: 10px; margin-right: 10px" align="justify">
				<font size="1" face="Verdana, Arial, Helvetica, sans-serif">
					<b>Investing in education<br>
				</b><br>
					...
					developing their own country,” Sultan advises.<br>
					<br>
					...
					leadership of His Majesty Sultan Qaboos bin Said.<br>
					<br>
					...
					worship” and have the requisite skillsets.</font></p>
                    <font size="1" face="Verdana, Arial, Helvetica, sans-serif">
					<hr width="98%" size="1">
				<p style="margin-left: 10px; margin-right: 10px" align="justify">&nbsp;</p>
					</font></p>
				<div align="center">
					<table border="0" width="90%" bgcolor="#EFEFE9">
						<tr>
							<td height="30">
							<p style="margin-left: 10px; margin-right: 10px" align="justify">
							<font size="1" face="Verdana, Arial, Helvetica, sans-serif">
							<b>We are flexible and open: Ministry of Manpower</b></font></td>
						</tr>
						<tr>
							<td>
							...
							<font size="1" face="Verdana, Arial, Helvetica, sans-serif">
							<b>
							<img src="images/cover_box_jan2010.jpg" width="150" height="182" hspace="9" vspace="5" border="0" align="left">Hamad 
							bin Hilal Al Busaidi, Undersecretary for Labour, 
							Ministry of Manpower responds to some of the issues 
							raised by the private sector<br>
							</b><br>
							<b>On Job codes</b><br>
							...
							<br>
							<b>Need more time to comply with</b><br>
							...
							<br>
							<b>Casual and temporary workforce</b><br>
	...
	<tr>
		        <td> <p align="right" style="margin: 5"> <font face="Verdana" size="1"> 
                    <a href="#top">Top^<br>
                    <br>
                    </a></font></td>
	</tr>
