...
<table border="0" cellpadding="0" cellspacing="0" width="100%" style="border-collapse: collapse" bordercolor="#111111">
	...
	<tr>
						...
						The OECD Anti-Bribery Convention<br>
						...
						international bribery</font></b><p align="justify" style="margin: 3px 10px">&nbsp;<p align="justify" style="margin: 3px 10px">
						<i><font face="Verdana" size="1">By James Harbridge</font></i><b><font face="Verdana" size="2"><br>
&nbsp;</font></b><p align="justify" style="margin: 3px 10px" dir="ltr">
				...
				which are not a party to the Anti-Bribery Convention.<br>
				<br>
				<b>Standards to fight bribery<br>
				</b>Parties to the Convention have made bribing of foreign 
				...
				most significant provisions require parties to:<br>
				Criminalise bribery of foreign public officials in international 
				business transactions <br>
				Provide a definition of a “foreign public official” <br>
				<br>
				Set accounting and auditing standards for prohibiting the use of 
				accounting documents for bribing.<br>
				<br>
				...
				practices.<br>
				<br>
				<b>Practical Impacts of the Convention<br>
				</b>The regulatory changes have important consequences. 
				...
				undergo a compliance review.<br>
				<br>
				...
				and prevent malpractice include:<br>
				<br>
				<b>Codes of conduct<br>
				</b>Compliance programmes to ensure that the values of the 
				...
				systems are established by the company.<br>
				<br>
				...
				corruption in public contracting.<br>
				<br>
				<b>The UN Convention Against Corruption<br>
				</b>The OECD Anti-Bribery Convention and the UNCAC (United 
				...
				with governments to promote anti-corruption activities.<br>
				<br>
				...
				unfavourable media attention.&#8194;</font></td>
					</tr>
	<tr>
