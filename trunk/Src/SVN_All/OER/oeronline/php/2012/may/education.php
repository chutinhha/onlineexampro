            ...
            <div align="left">
				<table border="0" style="border-collapse: collapse" width="175" cellpadding="0">
                  ...
                  <td valign="bottom" style="border-bottom-style: solid; border-bottom-width: 1px; padding-left: 4px; padding-right: 4px; padding-top: 1px; padding-bottom: 1px" bordercolor="#FF0000" width="131"> 
					...
					<span class="style26"><strong>EDUCATION</strong></span></a></td>
					</tr>
				</table>
			</div>
			</td>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%" style="border-collapse: collapse" bordercolor="#111111">
	...
	<tr>
				...
				<b>
				<font face="Verdana" size="4" color="#C00000">A befitting 
				recognition</font></b><p align="justify" class="style13">
				...
				salience in promoting and encouraging young Omani’s. A report<p align="center" class="style13">
				<br>
				<img border="0" src="images/education-may-12-1.jpg" width="346" height="222" hspace="12" vspace="3"><p align="justify" class="style13">
				...
				Award. Excerpts from an interview with Mayank Singh.<br>
				<br>
				...
				attributes that enabled you to win this coveted recognition? <br>
				<br>
				<img border="0" src="images/education-may-12-2.jpg" width="150" height="225" align="right" hspace="12" vspace="3">I 
				...
				an extensive leadership course over a week’s time.<br>
				<br>
				<b>Tell us something about your educational and professional 
				background?<br>
				</b>After graduating from high school I went to the US for a 
				...
				family and country then you are leading a good career.<br>
				<br>
				<b>There is a lot of stress on building local national talent in 
				Oman. What would your advice be to young Omanis who are 
				embarking on a career?<br>
				</b>My advice to young Omanis is that you should not expect a 
				...
				be appreciated.<br>
				<br>
				<b>Apart from education and intellect, there is a lot of stress 
				on soft skills in today’s management studies. How important is 
				the softer side of business?<br>
				</b>Soft skills are extremely important as working in teams and 
				...
				the day it all counts.<br>
				<br>
				<b>Looking at Oman do you feel that there are a lot of 
				opportunities for youngsters who have the right education and 
				are ready to work hard?<br>
				</b>Sky is the limit in places like the Gulf, as ours are new 
				...
				who will be building our future.<br>
				<br>
				<b>What do you think about the BizPro Awards and in what ways is 
				it beneficial in promoting national talent?</b><br>
				...
				participation of the ministry staff which is important. <br>
				<br>
				<b>Push yourself to the limits<br>
				</b><br>
				<img border="0" src="images/education-may-12-3.jpg" width="150" height="225" align="right" hspace="12" vspace="3">Khalid 
				M Al Barwani, Team Leader –General Trading, Corporate Banking, 
				ahlibank and one of the winner of BizPro Awards Young Achiever 
				Award in 2011, speaks to OER.<br>
				<br>
				<b>You were one of the winners in the Young Achievers category 
				at BizPro Awards 2011. What were the factors that helped you win 
				this award?<br>
				</b>It is nothing magical, but the result of hard work, 
				...
				work that you put in.<br>
				<br>
				<b>You have done very well at a young age, what would you 
				suggest or advise young Omanis who are looking at embarking on a 
				career? <br>
				</b>It’s more or less the same as I have done in the beginning 
				of my career. Apart from that try and push yourself to the 
				limits and do not be afraid of taking risks. Never stop learning 
				and educating yourself as this is very important.<br>
				<br>
				<b>What do you think about the BizPro Awards and in what ways is 
				it beneficial in promoting national talent?<br>
				</b>Definitely the BizPro Awards is a good programme to promote 
				...
				on these tests the winners are chosen.<br>
				<br>
				<b>What do organisations or companies expect from fresh 
				graduates in today’s working environment and how can youngsters 
				equip themselves with the requisite skillsets?<br>
				</b>Organisations expect people to have a lot of soft skills 
				...
				<br>
				<b>How important is training for someone to get acquainted with 
				global cross currents and to grow, and are there enough training 
				opportunities in Oman?<br>
				</b>It depends on the industry, in banking there are enough 
				...
				such needs and giving it more significance. <br>
				<br>
				<b>In today’s demanding corporate culture how can executives 
				strike a work-life balance?<br>
				</b>Time management is extremely important. At the end of the 
				...
				the day one needs to devote time and attention to one’s family.&#8194;</td>
					</tr>
	<tr>
