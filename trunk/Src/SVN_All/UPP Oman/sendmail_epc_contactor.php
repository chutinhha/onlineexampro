...
$mail = new PHPMailer();
		...
		$mail->Subject = "BEST EPC CONTRACTOR";
		$mail->IsHTML(true);
  ...
  <tr>
    ...
    <td>:</td>
    <td>".$_REQUEST['most_outstanding_project']."</td>
  </tr>
  <tr>
    <td>As an EPC contractor, what have been your key contributions in executing them? </td>
    <td>:</td>
  ...
  <tr>
    <td>Tell us about your main achievements in training your staff and developing Omani talent? </td>
    <td>:</td>
    <td>".$_REQUEST['main_achievements_training']."</td>
  </tr>
  <tr>
    <td>What are your major accomplishments in adopting and following best HSE practices?</td>
    <td>:</td>
    <td>".$_REQUEST['major_accomplishments']."</td>
  </tr>
  <tr>
    <td>What are the key awards or certifications you have received from your clients or third party bodies? </td>
    <td>:</td>
