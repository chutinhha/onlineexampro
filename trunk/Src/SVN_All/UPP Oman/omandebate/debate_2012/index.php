			...
			<table border="0" cellpadding="0" style="border-collapse: collapse" width="994" bgcolor="#C9D0D4">
				<tr>
					<td width="559" valign="top"><object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,28,0" width="559" height="636">
                      <param name="movie" value="images/oer-b.swf">
				  ...
				  <td valign="top">
					<table border="0" cellpadding="0" style="border-collapse: collapse" width="100%">
						...
						<tr>
							...
							TIM BRINGS THE HARD TALK TO OMAN</font><p style="line-height: 20px" align="justify">
									...
									<table border="0" cellpadding="0" style="border-collapse: collapse" width="100%" height="80">
										<tr>
											...
											<?php
												...
												$rec_limit = 1;
												$cntQuery = mysql_query("SELECT id FROM question WHERE pub=1 and year(`date`) = 2011");
												...
												$nxtQuery = mysql_query("SELECT id FROM question WHERE id > $page  and year(`date`) = 2011 ORDER BY id ASC LIMIT 1");
												$nxtVal = mysql_fetch_array($nxtQuery);
												$nxt = $nxtVal[id];
												
												$prevId = $page-2;
												$prevQuery = mysql_query("SELECT id FROM question WHERE id < $page  and year(`date`) = 2011 ORDER BY id DESC LIMIT 1");
												$prevVal = mysql_fetch_array($prevQuery);
												$prev = $prevVal[id];
												
												$votQuery = mysql_query("SELECT * FROM question WHERE id=$page  and year(`date`) = 2011 AND deleted=0");
