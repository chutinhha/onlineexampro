...
<form action="" method="post" name="frmVote">
  <table width="90%" border="0" cellspacing="0" cellpadding="5" align="center" style="font-family:Verdana; font-size: 8pt; color:#252525;">
    <tr>
      <td><input name="rdAns" type="radio" value="1" onClick="newWindow('userDetails.php?agr=1&amp;qId=<?php echo $vote[id]; ?>','','350','300','resizable,scrollbars,status,toolbar')" <?php echo $noPoll; ?>>
       <?php echo $vote['ans1']; ?></td>
    </tr>
    <tr>
      <td background="images/vote_bg.gif" height="2px" style="padding: 0px;"></td>
    </tr>
    <tr>
      <td><input name="rdAns" type="radio" value="0" onClick="newWindow('userDetails.php?agr=0&amp;qId=<?php echo $vote[id]; ?>','','350','300','resizable,scrollbars,status,toolbar')" <?php echo $noPoll; ?>>
        <?php echo $vote['ans2']; ?></td>
    </tr>
    <tr>
      <td background="images/vote_bg.gif" height="2px" style="padding: 0px;"></td>
    </tr>
    <tr>
      <td><table width="100%" border="0" cellspacing="0" cellpadding="3" align="center" style="font-family:Verdana; font-size: 8pt; color:#252525;">
          <tr>
            <td width="110"><?php echo $vote['ans1']; ?></td>
            <td align="left">
<div class="voteResBg">
                	<div class="voteRes" style="width: <?php echo $resAgr; ?>%;"></div>
            </div>            </td>
            <td width="40" align="left" ><?php echo $resAgr; ?>%</td>
          </tr>
          <tr>
            <td><?php echo $vote['ans2']; ?></td>
            <td align="left">
       	  <div class="voteResBg">
                	<div class="voteResDis" style="width: <?php echo $resDisAgr; ?>%;"></div>
            </div>            </td>
            <td align="left"><?php echo $resDisAgr; ?>%</td>
          </tr>
        </table></td>
    </tr>
  </table>
