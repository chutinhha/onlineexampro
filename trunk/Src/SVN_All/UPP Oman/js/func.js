...
jQuery(function($) {
    ...
    function dimensions() {
		...
		else if (screenWidth > 640 && screenWidth < 1060)  {
			result[0] = 1000;
		}
        else {
            result[0] = 1100;
        ...
        else if (bodyWidth > 640 && bodyWidth < 1060) {
            result[1] = 1000;
        }
        else {
            result[1] = 1100;
    ...
    // Attach google map
        // create map center
        var latlng = new google.maps.LatLng(23.59797,58.5569); 
        // Create map options
        var options = {  
            zoom: 7,
            center: latlng,
        ...
        var marker = new google.maps.Marker({
                position: new google.maps.LatLng(23.59797,58.5569), 
                map: map,
                title : 'We are here'
            });
    }
