...
$mail = new PHPMailer();
		...
		$mail->Subject = "BEST MEP CONTRACTOR";
		$mail->IsHTML(true);
  ...
  <tr>
    <td>As an MEP contractor, what have been your key contributions in executing them?</td>
    <td>:</td>
  ...
  <tr>
    <td>What are the key awards or certifications you have received<br /> from your clients or third party bodies?</td>
    <td>:</td>
