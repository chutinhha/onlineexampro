...
include("db.php");
$id=$_REQUEST['id'];
$result = mysql_query("SELECT * FROM tbform ");
?>
  <table    class="downtable">
    <tr>
      <th width="27%" align='center'> NAME</th>
      <th width="27%" align='center'>EMAIL</th>
      <th width="18%" align='center'>DATE</th>
      <th width="28%" align="center">DOWNLOAD</th>
    </tr>
	</thead>
    <?php
...
while($row = mysql_fetch_array($result))
  ...
  if(strlen($upload)>0)
  {
  $downloadlink = "<a href='zip.php?id=".$row['id']."'>Download Collections </a>";
	}
	else
	$downloadlink ="<span style='color:#cccccc'>Download Collections</span>";
 ?>
    <tr >
      <td >&nbsp;<?php echo $row['name']?></td>
      <td >&nbsp;<?php echo $row['email']?></td>
      <td align='center' >&nbsp;<?php echo $row['date']?></td>
<?php echo "<td align='center'> ".$downloadlink."</td>";?>
    </tr>
    <?php
  }
