...
if (f1.txtEmail.value=="")
	...
	if(f1.selNomCategory.value == "Select")
	{
      alert('Please Select a Nomination Category');
	  f1.selNomCategory.focus();
      return false;
	}
                                  ...
                                  <tr>
                                    <td width="523" bgcolor="#fff"><form name="formname" class="iform" method="post" action="nomination_ mail.php"  onsubmit="return checkCheckBox(this)" enctype="multipart/form-data">
                                        ...
                                        <table width="500" border="0" align="center" cellpadding="4"  class="tblestyle">
                                          ...
                                          <tr>
                                            <td height="25" colspan="2">Nomination Category</td>
                                            <td width="191" height="25"><select name="selNomCategory" id="selNomCategory">
                                            <option value="Select">Select</option>
                                            	<option value="Al Mar'a Excellence Award for Corporate Leadership">Al Mar'a Excellence Award for Corporate Leadership</option>
                                                <option value="Al Mar'a Excellence Award for Fashion Design">Al Mar'a Excellence Award for Fashion Design</option>
                                                <option value="Al Mar'a Excellence Award for Performing Arts">Al Mar'a Excellence Award for Performing Arts</option>
                                                <option value="Al Mar'a Excellence Award for Fine Arts">Al Mar'a Excellence Award for Fine Arts</option>
                                                <option value="Al Mar'a Excellence Award for Educational services">Al Mar'a Excellence Award for Educational services</option>
                                                <option value="Al Mar'a Excellence Award for Entrepreneurship and Innovation">Al Mar'a Excellence Award for Entrepreneurship and Innovation</option>
                                                <option value="Al Mar'a Excellence Award for Health Services">Al Mar'a Excellence Award for Health Services</option>
                                                <option value="Al Mar'a Excellence Award for achievements in Science and Industry">Al Mar'a Excellence Award for achievements in Science and Industry</option>
                                                <option value="Al Mar'a Excellence Award for Technology">Al Mar'a Excellence Award for Technology</option>
                                                <option value="Al Mar'a Excellence Award for Sports">Al Mar'a Excellence Award for Sports</option>
                                                <option value="Al Mar'a Excellence for Social Responsibility">Al Mar'a Excellence for Social Responsibility</option>
                                                <option value="Al Mar'a Excellence Award for Petroleum Services">Al Mar'a Excellence Award for Petroleum Services</option>
                                                <option value="Al Mar'a Excellence Award for SME Sector">Al Mar'a Excellence Award for SME Sector</option>
                                            </select>
                                              <span class="mandetory">*</span></td>
                                          </tr>
                                          <tr>
