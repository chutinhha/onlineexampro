...
$mail = new PHPMailer();
		...
		$mail->Subject = "BEST RESIDENTIAL PROJECT";
		$mail->IsHTML(true);
  ...
  <tr>
    <td>What makes the project a unique residential project? </td>
    <td>:</td>
    <td>".$_REQUEST['unique_residential']."</td>
  </tr>
  <tr>
    <td>How it scores highly in terms of sustainability and HSE requirements? </td>
    <td>:</td>
    <td>".$_REQUEST['hse_requirements']."</td>
  </tr>
  <tr>
