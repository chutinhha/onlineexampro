...
<div class="dnnPE-Mobile interior">
	<div class="dnnPEM-Header dnnClear">        
        <!-- use mobile home page url in href for redirect to mobile home, in lieu of the javascript method -->
		<a href="javascript:history.back();"><div class="dnnPEM-Logo dnnLeft"/></div></a>
        <a href="" class="navTrigger dnnRight"><span>Menu</span></a>
	</div>   
	<div><dnn:MENU MenuStyle="DNNMobileNav" runat="server" NodeSelector="RootChildren"></dnn:MENU></div>
