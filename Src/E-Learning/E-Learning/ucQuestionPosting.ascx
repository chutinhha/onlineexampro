<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucQuestionPosting.ascx.cs" Inherits="E_Learning.ucQuestionPosting" %>
<table>
<tr>
<td>
...
<td>
    <asp:TextBox ID="txtQuestion" runat="server" Height="60px" TextMode="MultiLine" 
