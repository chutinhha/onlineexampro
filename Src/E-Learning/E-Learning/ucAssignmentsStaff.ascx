<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucAssignmentsStaff.ascx.cs" Inherits="E_Learning.ucAssignmentsStaff" %>
<style type="text/css">
    .style1
    {
        width: 100%;
            ...
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Verify">
                        <ItemTemplate>
                            <asp:LinkButton ID="HyperLink1" runat="server" CommandName="Verify" CommandArgument='<%# Eval("Id") %>' Text="Verify"></asp:LinkButton>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="View">
                        <ItemTemplate>
                            <asp:LinkButton ID="lnkView" runat="server" CommandName="View" CommandArgument='<%# Eval("Id") %>' Text="View"></asp:LinkButton>
                        </ItemTemplate>
                    </asp:TemplateField>
