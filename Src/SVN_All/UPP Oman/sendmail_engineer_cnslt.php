...
$mail = new PHPMailer();
		...
		$mail->Subject = "BEST ENGINEERING CONSULTANT";
		$mail->IsHTML(true);
  ...
  <tr>
    <td>From the engineering consultancy perspective, <br />what have been their distinguishing features that made those projects unique?</td>
    <td>:</td>
    <td>".$_REQUEST['distinguishing_features']."</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td>:</td>
    <td>".$_REQUEST['main_achievement']."</td>
  </tr>
  <tr>
