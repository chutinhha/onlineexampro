                          ...
                          <td width="100%" align="right" height="38"><div align="center">
                              <center>
                                <table border="0" cellpadding="0" bgcolor="#E4E4E4" width="90%" style="border-collapse: collapse" bordercolor="#111111" cellspacing="0" height="664">
                                  <tr>
                                    <td width="523" bgcolor="#fff"><form name="formname" class="iform" method="post" action="nomination_ mail.php"  onsubmit="return checkCheckBox(this)">
                                        ...
                                        <table width="60%" border="0" align="center" cellpadding="4"  class="tblestyle">
                                          <tr>
                                            <td colspan="3" style="padding: 15px 0 5px 0;"><strong>Personal Details</strong></td>
                                          </tr>
                                          <tr>
                                          ...
                                          <tr>
                                            <td height="22" colspan="3" style="padding: 15px 0 5px 0;"><b>Contact Details</b></td>
                                          </tr>
                                          <tr>
                                        ...
                                        <table width="100%" border="0" cellspacing="0" cellpadding="5" class="tblestyle" style="margin: 10px 0;">
                                          <tr>
                                            <td height="20" bgcolor="#F9E3F7"><strong>Section B</strong></td>
                                          </tr>
                                        </table>
                                        <table width="60%" border="0" align="center" cellpadding="4"  class="tblestyle">
                                          <tr>
                                            <td height="25" colspan="2">Award Category:</td>
                                            <td width="191" height="25"><input type="text" name="txtAward"  value="<?php echo $_SESSION['formValues']['txtAward'];?>"></td>
                                          </tr>
                                          <tr>
                                            <td height="22" colspan="3" style="padding: 15px 0 5px 0;"><b>Credentials</b></td>
                                          </tr>
                                          <tr>
                                          ...
                                          <tr>
                                            <td height="22" colspan="3" style="padding: 15px 0 5px 0;"><b>Employment/ Work</b></td>
                                          </tr>
                                          <tr>
                                          ...
                                          <tr>
                                            <td height="22" colspan="3" style="padding: 15px 0 5px 0;"><b>Career
                                              Accomplishments</b></td>
                                          </tr>
                                          <tr>
                                            <td width="200" >List of Achievements in Career:</td>
                                            <td width="14" >1</td>
                                          ...
                                          <tr>
                                            <td >&nbsp;</td>
                                            <td >2</td>
                                            <td><input type="text" name="AchievemtList2" id="AchievemtList2" onBlur="return enableAchive('AchievemtList2')" value="<?php echo $_SESSION['formValues']['AchievemtList2'];?>"></td>
                                          </tr>
                                          <tr>
                                            <td >&nbsp;</td>
                                            <td >3</td>
                                            <td><input type="text" name="AchievemtList3" id="AchievemtList3" onBlur="return enableAchive('AchievemtList3')" value="<?php echo $_SESSION['formValues']['AchievemtList3'];?>"></td>
                                          </tr>
                                          <tr>
                                            <td >&nbsp;</td>
                                            <td >4</td>
                                            <td><input type="text" name="AchievemtList4" id="AchievemtList4" onBlur="return enableAchive('AchievemtList4')" value="<?php echo $_SESSION['formValues']['AchievemtList4'];?>"></td>
                                          </tr>
                                          <tr>
                                            <td >&nbsp;</td>
                                            <td >5</td>
                                            <td><input type="text" name="AchievemtList5" id="AchievemtList5" onBlur="return enableAchive('AchievemtList5')" value="<?php echo $_SESSION['formValues']['AchievemtList5'];?>"></td>
                                          </tr>
                                          <tr>
                                            <td >&nbsp;</td>
                                            <td >6</td>
                                            <td><input type="text" name="AchievemtList6" id="AchievemtList6" onBlur="return enableAchive('AchievemtList6')" value="<?php echo $_SESSION['formValues']['AchievemtList6'];?>"></td>
                                          </tr>
                                          <tr>
                                            <td >&nbsp;</td>
                                            <td >7</td>
                                            <td><input type="text" name="AchievemtList7" id="AchievemtList7" onBlur="return enableAchive('AchievemtList7')" value="<?php echo $_SESSION['formValues']['AchievemtList7'];?>"></td>
                                          </tr>
                                          <tr>
                                            <td >&nbsp;</td>
                                            <td >8</td>
                                            <td><input type="text" name="AchievemtList8" id="AchievemtList8" onBlur="return enableAchive('AchievemtList8')" value="<?php echo $_SESSION['formValues']['AchievemtList8'];?>"></td>
                                          </tr>
                                          <tr>
                                            <td >&nbsp;</td>
                                            <td >9</td>
                                            <td><input type="text" name="AchievemtList9" id="AchievemtList9" onBlur="return enableAchive('AchievemtList9')" value="<?php echo $_SESSION['formValues']['AchievemtList9'];?>"></td>
                                          </tr>
                                          <tr>
                                            <td >&nbsp;</td>
                                            <td >10</td>
                                            <td><input type="text" name="AchievemtList10" id="AchievemtList10" onBlur="return enableAchive('AchievemtList10')" value="<?php echo $_SESSION['formValues']['AchievemtList10'];?>"></td>
                                          </tr>
                                          <tr>
                                            <td colspan="3" align="left"><em>Please provide supporting documentation for your list of achievements, with a description elaborating each achievement and images</em></td>
                                          </tr>
                                        </table>
                                        <table width="100%" border="0" cellspacing="0" cellpadding="5" class="tblestyle" style="margin: 10px 0;">
                                          <tr>
                                            <td height="20" bgcolor="#F9E3F7"><strong>Section C</strong><br>
                                              <em>Section C is to be repeated for each Achievement listed in Section B</em></td>
                                          </tr>
                                        </table>
                                        <table width="60%" border="0" align="center" cellpadding="4"  class="tblestyle">
                                          <tr>
                                            <td colspan="2" valign="top" id="careerAchi"></td>
                                          </tr>
                                          <tr>
                                            <td><p style="margin-right: 9px; margin-bottom: 8px">Security Code</p></td>
                                            <td width="191"><a name="cde"></a>
                                          ...
                                          <tr>
                                            <td colspan="2" align="center"><input class="ibutton" type="submit" value="Submit" name="B1" style="margin-top: 15px; width: 80px;">
