                                        ...
                                        <tr>
                                            ...
                                            <td valign="top" width="82%">
                                                ...
                                                <p style="line-height: 20px" align="justify">
                                                    ...
                                                    Oman Economic Review in association with Capital 
                                                    ...
                                                    on Apirl, 2014 from 9.00 am - 12.30 pm. <br>
                                                    <br>
                                                    The Topic of this year's Debate is - In-Country Value Oman - The National Priority.
                                                    The Oman Debate will raise and address issues 
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="115" valign="top" style="width: 261px">
                                                            <table class="auto-style1">
                                                                <tr>
                                                                    <td style="color: #C0C0C0">STRATEGIC PARTNERS</td>
                                                                    <td style="color: #C0C0C0">SUPPORT PARTNERS</td>
                                                                    <td style="color: #C0C0C0">MEDIA PARTNERS</td>
                                                                    <td style="color: #C0C0C0">PRINT PARTNER</td>
                                                                </tr>
                                                                <tr>
                                                                    <td style="border-right-style: solid; border-right-width: 1px; border-right-color: #000000">
                                                                        <img border="0" width="150px" height="150px" src="images/galfar-logo.jpg">
                                                                    </td>
                                                                    <td style="border-right-style: solid; border-right-width: 1px; border-right-color: #000000">
                                                                        <table>
                                                                            <tr>
                                                                                <td>
                                                                                    <img border="0" width="150px" height="150px" src="images/alhabib_logo.jpg">
                                                                                </td>
                                                                                <td>
                                                                                    <img border="0" width="150px" height="150px" src="images/sharq_sohar_logo.jpg">
                                                                                </td>
                                                                            </tr>
                                                                        </table>
                                                                    </td>
                                                                    <td style="border-right-style: solid; border-right-width: 1px; border-right-color: #000000">
                                                                        <table>
                                                                            <tr>
                                                                                <td>
                                                                                    <img border="0" width="150px" height="150px" src="images/shabibah_logo-new.jpg">
                                                                                </td>
                                                                                <td>
                                                                                    <img border="0" width="150px" height="150px" src="images/timesofoman_logo-new.jpg">
                                                                                </td>
                                                                            </tr>
                                                                        </table>                                
                                                                    </td>
                                                                    <td>
                                                                        <img border="0" width="150px" height="150px" src="images/mazoon_logo.jpg">
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                        </td>
                            ...
                            <tr>
                                <td width="510">
									...
									<a style="text-decoration: none" target="_blank" href="debate_2011">
                                        <font color="#FFFFFF">View Debate 2011</font></a>
                                    &nbsp; |
                                ...
                                <td>
                                    <p align="right">
                                        ...
                                        (c) OMAN Debate 2014, Sultanate of Oman</font></td>
                            </tr>
                        </table>
                    </td>
                </tr>
