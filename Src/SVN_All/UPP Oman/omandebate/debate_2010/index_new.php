									...
									<table border="0" cellpadding="0" style="border-collapse: collapse" width="100%" height="80">
										<tr>
											...
											<?php
												...
												$retval = mysql_query( $sql) or die('Could not get data: ' . mysql_error());
												...
												}else
												{
												   ...
												   $query ="deleted=0 LIMIT $offset, $rec_limit";
												}
												else
												{
												   $page = 0;
												   $offset = 0;
												   $query ="pub=1 AND deleted=0";
												}
echo 'page:'.$page.' ';
												$left_rec = $rec_count - ($page * $rec_limit);
												$votQuery = mysql_query("SELECT * FROM question WHERE ".$query);
								...
								<tr align="center" valign="middle">
									...
									if( $page > 0  && $left_rec >= $rec_limit  && $_GET{'page'} < $rec_count-2)
										{
										   $last = $page - 2;
										   echo "<a href=\"$_PHP_SELF?page=$last\" class='page'><< Previous</a> | ";
										   echo "<a href=\"$_PHP_SELF?page=$page\" class='page'>Next >></a>";
										}
										else if( $page == 0 && $_GET{'page'} < $rec_count)
										{
										   echo "<a href=\"$_PHP_SELF?page=$page\" class='page'>Next >></a>";
										}
                        ...
                        <tr>
                          ...
                          <td width="115" valign="top" style="width: 261px"><font face="Verdana" style="font-size: 8pt; font-weight: 700" color="#464646"> <a target="_blank" href="http://www.timesofoman.com/">
                            <map name="FPMap0" id="FPMap0">
                              <area target="_blank" href="http://www.banksohar.com/bankSohar/index.jsp" shape="rect" coords="472,4,578,107">
                              <area target="_blank" href="http://www.shabiba.com/" shape="rect" coords="95,73,171,105">
                              <area target="_blank" href="http://www.timesofoman.com/" shape="rect" coords="5,74,81,104">
                            </map>
