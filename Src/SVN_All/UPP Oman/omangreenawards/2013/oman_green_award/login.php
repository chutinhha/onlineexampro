        ...
        <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" width="100%" id="AutoNumber4" height="895">
          ...
          <tr>
            ...
            <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" width="100%" id="AutoNumber16" height="384">
              <tr>
                <td width="22%" height="384" valign="top">
			   
			   <!--...................................Login Table ...........................-->
			   <?php 
			   if(isset($_REQUEST[flag]))
			  echo '<div style="width:95%;margin-top:10px;color:#FF0000;text-align:center " class="fontstyle">Login Faild..!</div>';
			  ?>
			   <table width="300" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#CCCCCC" style="margin-top:30px;font-family:Verdana, Arial, Helvetica, sans-serif;font-size:8pt !important; ">
<tr>
<form name="form1" method="post" action="checklogin.php">
<td>
<table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#FFFFFF">
<tr>
<td colspan="3"><strong><font face="Verdana" style="font-size: 8pt"> Login </font></strong></td>
</tr>
<tr>
<td width="78" class="fontstyle">Username</td>
<td width="6">:</td>
<td width="294"><input name="txtuname" type="text" id="txtuname" class="fontstyle"></td>
</tr>
<tr>
