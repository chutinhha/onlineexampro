...
<!--html code's end -->
		...
		else
		{
			...
			$sql="insert into OER (name,desi,comp,email,id,pwd)values('".$HTTP_SESSION_VARS["name"]."','".$HTTP_SESSION_VARS["desi"]."','".$HTTP_SESSION_VARS["comp"]."',"'lower('".$HTTP_SESSION_VARS["email"]."'),lower('".$HTTP_SESSION_VARS["id"]."'),'".$HTTP_SESSION_VARS["pwd"]."')";
