...
$publicationquery	= "SELECT * FROM `".TB_PUBLICATIONS."` Where Pub_month='".$gm."' AND Pub_year='".$gy."' AND Cat_id!='10' AND publish=1 ORDER BY Pub_id ASC";
...
$publicationquery	= "SELECT * FROM `".TB_PUBLICATIONS."` Where Pub_month='".$m."' AND Pub_year='".$y."' AND Cat_id!='10' AND publish=1 ORDER BY Pub_id ASC";
$publicationres = mysql_query($publicationquery);
}
//print_r($ecorow);
?>
...
&nbsp;</font></b></td>
  ...
  <?php
									preg_match_all("#<p.*?>([^<]+)</p>#", $box2row['Auto_desc'], $box2);
														...
														echo substr($box2val, 0, 290)."...";
					//echo substr($box2row['Auto_desc'], 0, 420)."...";
					
					?> </div><p dir="ltr" class="style9" style="text-align:right;"> 
...
<div  class="boxdesc">
				<?php
					echo substr($box3row['Auto_desc'], 0, 290)."...";
      ...
      <table border="1" cellspacing="0" style="border-collapse: collapse" bordercolor="#999999" width="29%" id="AutoNumber3" cellpadding="0" height="73" align="center">
        <tr>
          ...
          <?php include("inc/e-magazineslider.php"); ?>
         </td>
        </tr>
      </table>
          </td>
                                          ...
                                          <td bgcolor="#F7F7F7" dir="ltr"> <table border="0" width="100%" cellspacing="1" dir="ltr">
                                              <tr>
                                                ...
                                                <?php
												  ...
												  ?>
																		  <p align="center"> 
									<img border="0" src="uploads/headlines/<?php echo $box4row['Auto_img']; ?>" style="max-width:300px;">
                                    </p>
													<?php } ?> 
												<div  class="boxdesc">
													<?php
                                          ...
                                          <td bgcolor="#F7F7F7" dir="ltr"> <table border="0" width="100%" cellspacing="1" dir="ltr">
                                              <tr>
                                                ...
                                                <?php
												  ...
												  ?>
																		  <p align="center"> 
									<img border="0" src="uploads/headlines/<?php echo $box5row['Auto_img']; ?>" style="max-width:300px;">
                                    </p>
													<?php } ?> 
												<div  class="boxdesc">
												<?php
                                  ...
                                  <tr> 
                                    <td dir="ltr"> <div align="center" dir="ltr"> 
										...
										//print_r($publicationrow);
												...
												<h6><?php echo $pcname; if($publicationrow['Pub_title']!=""){ echo "&nbsp;".$publicationrow['Pub_title']; } ?></h6>
                                                <?php
                                                //$str = stripslashes($publicationrow['Pub_intro']);
																//echo $str = mysql_real_escape_string($str);
																$str_temp =  stripslashes($publicationrow['Pub_intro']);
																$str = stripslashes($str_temp); 
																echo substr($str, 0, 186)."..."; 
                                                 //echo stripslashes($publicationrow['Pub_intro']); ?>
												  ...
												  <tr>
												<td width="100%" align="left" dir="ltr" colspan="2">
                                                <?php
...
<?php if($publicationrow['Pub_link_eng']!="" || $publicationrow['Pub_link_ara']!=""){ ?>
<td style="padding:0;"  class="publinks">
<p>
e-Magazine
<?php if($publicationrow['Pub_link_eng']!=""){ ?> [<a href="<?php echo $publicationrow['Pub_link_eng']; ?>" target="_blank">Eng</a>] <?php } ?><?php if($publicationrow['Pub_link_ara']!=""){ ?> [<a href="<?php echo $publicationrow['Pub_link_ara']; ?>" target="_blank">Ara</a>] <?php } ?>
</p>
</td>
<?php } ?>

<?php if($publicationrow['Pub_link_arch_eng']!="" || $publicationrow['Pub_link_arch_ara']!=""){ ?>
<td  class="publinks">
<p>
Archives
<?php if($publicationrow['Pub_link_arch_eng']!=""){ 
?> [<a href="<?php echo $publicationrow['Pub_link_arch_eng']; ?>" target="_blank">Eng</a>] 
<?php } ?>
<?php if($publicationrow['Pub_link_arch_ara']!=""){ ?> [<a href="<?php echo $publicationrow['Pub_link_arch_ara']; ?>" target="_blank">Ara</a>]<?php } ?>
</p></td>
<?php } ?>
</tr></table>
<?php
                                  ...
                                  <tr> 
                                    <td dir="ltr"> <hr size="1" width="95%" dir="ltr" style="margin-bottom:0;"></td>
                                  </tr>
                                </table>
												  </td>
                          </tr>
                                            ...
                                            <td height="202" bgcolor="#F7F7F7" dir="ltr"> 
                                              <table width="100%" border="0" cellspacing="0" cellpadding="0" dir="ltr">
                                                <tr> 
                                                  ...
                                                  <?php
												  if($gm!="" && $gy!=""){
													$publicationquery	= "SELECT * FROM `".TB_PUBLICATIONS."` Where Pub_month='".$gm."' AND Pub_year='".$gy."' AND Cat_id='10' AND publish=1";
													$publicationres = mysql_query($publicationquery);
													$publicationrw=mysql_fetch_assoc($publicationres);
													//print_r($publicationrw);
													}
													else{
													$publicationquery	= "SELECT * FROM `".TB_PUBLICATIONS."` Where Pub_month='".$m."' AND Pub_year='".$y."' AND Cat_id='10' AND publish=1";
													$publicationres = mysql_query($publicationquery);
													$publicationrw=mysql_fetch_assoc($publicationres);
													//print_r($publicationrw);	
													}
		...
		<img border="0" src="uploads/publication_uploads/thumb/<?php echo $publicationrw['Pub_img_thumb_eng']; ?>" width="130" height="171"></div></td>
                                                </tr>
                                                <tr> 
                                                  <td height="33" dir="ltr"> <div align="center" dir="ltr"> 
                                                      <p style="line-height: 15px" dir="ltr"><big><big><big><big><font face="Verdana, Arial, Helvetica, sans-serif" size="1">eMagazine 
                                                        - Click
														<a target="_blank" href="<?php echo $publicationrw['Pub_link_eng']; ?>">here</a></font></big></big></big></big><br>
                                                        <big><big><big><big><font face="Verdana, Arial, Helvetica, sans-serif" size="1"> 
                                                        Archives - Click 
														<a href="<?php echo $publicationrw['Pub_link_arch_eng']; ?>">here</a></font></big></big></big></big></div></td>
                                                </tr>
                                                <tr> 
		...
		<font face="Verdana" size="1" color="#CC3333"><?php echo $box6row['Auto_title']; ?></font></b></a>
									...
									preg_match_all("#<p.*?>([^<]+)</p>#", $box6row['Auto_desc'], $box6);
													...
													?></div></div><p align="right" style="margin-left:3px; margin-right:3px; margin-top:5px; margin-bottom:10px" dir="ltr"> 
                  ...
                  <tr>
                  <td style="background:#E2E2D3;padding:10px;" colspan="3" align="center">
                  <table style="margin:0 auto;"><tr><td>
                  <div class="footbox">
                  <table border="1" cellspacing="1" style="border-collapse: collapse;background:#F7F7F7;" bordercolor="#CCCCCC" width="136" id="AutoNumber9" height="32" dir="ltr">
                                    <tr> 
                                    ...
                                    <tr> 
                                      <td width="130" height="207" dir="ltr"> 
                                        <div align="center" dir="ltr"> 
                                          <p dir="ltr"> 
                  ...
                  <table border="1" cellspacing="1" style="border-collapse: collapse;background:#F7F7F7;" bordercolor="#CCCCCC" width="136" id="AutoNumber9" height="32" dir="ltr">
                          <tr>
                            <td width="158" valign="top" bgcolor="#F7F7F7" dir="ltr"> 
                              <p align="center">
								...
								<img border="0" src="images/scroll-portofoman-eng.jpg" width="130" height="184" style="border: 0px solid #9D0210; padding-left: 4px; padding-right: 4px; padding-top: 1px; padding-bottom: 1px"></a></td>
                          </tr>
							<tr>
                            <td width="158" valign="top" bgcolor="#F7F7F7" dir="ltr"> 
                                                      <p style="line-height: 15px; margin-top:5px; margin-bottom:5px" dir="ltr" align="center"><big><big><big><big><font face="Verdana, Arial, Helvetica, sans-serif" size="1">
                   ...
                   <div class="footbox" style="margin-right:0;">
                          <table border="1" cellspacing="1" style="border-collapse: collapse;background:#F7F7F7;" bordercolor="#CCCCCC" width="136" id="AutoNumber9" height="32" dir="ltr">
                          <tr>
                            <td width="158" valign="top" bgcolor="#F7F7F7" dir="ltr"> 
                              <p align="center">
								<img border="0" src="images/SIGNSHOW.jpg" width="130" height="212"></td>
                          </tr>
							<tr>
                            <td width="158" valign="top" bgcolor="#F7F7F7" dir="ltr"> 
                                                      <p align="center">
                                        <font color="#000000" face="Verdana" size="1"><u> <font color="#008000"> 
                                        	<a style="text-decoration: none" target="_blank" href="pdf/SIGNSHOW-Launch.pdf">Click here</a></font></u></font></p></td>
                          </tr>
                          </table>
                          </div>
                  </td></tr></table>
