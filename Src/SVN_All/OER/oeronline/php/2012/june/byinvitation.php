	...
	<tr>
		        <td valign="top" width="100%"> 
                  <p align="justify" style="margin: 3px 10px"> 
					...
					Ten commandments of SCM </font></b></p>
                </td>
		</tr>
	<tr>
		        <td valign="top" width="100%"> 
				...
				<b>Looking at supply chain management from a mathematical 
				perspective throws up some interesting insights<br>
				<br>
				By Ambuj Khare and Anurag Saxena<br>
				</b><br>
				<br>
				...
				ensuring good coordination between the alliances.<br>
				<br>
				...
				for the supply chain from the “additive” perspective.<br>
				<br>
				...
				provided through a supply chain. <br>
				<br>
				...
				Open University, New Delhi, India.</font></p>
                </td>
		</tr>
	<tr>
		        <td valign="top" width="100%"> 
