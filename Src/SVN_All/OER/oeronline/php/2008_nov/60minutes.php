      ...
      <div align="center">
        ...
        <table border="0" width="741" bgcolor="#FFFCE8" cellspacing="0" cellpadding="0" style="border-collapse: collapse" bordercolor="#111111">
          <tr>
            ...
            <div align="left">
				<table border="0" style="border-collapse: collapse" width="18%" cellpadding="0">
					<tr>
						...
						<td valign="bottom" style="border-bottom-style: solid; border-bottom-width: 1px; padding-left: 4px; padding-right: 4px; padding-top: 1px; padding-bottom: 1px" bordercolor="#FF0000" width="99">
            <p align="left" style="margin-left: 5px">
			<a name="MARKET WATCH"><span style="font-weight: 700">
			<font face="Verdana" style="font-size: 8pt">60 MINUTES</font></span></a></td>
					</tr>
				</table>
			</div>
			</td>
          ...
          <tr>
            ...
            <td width="492" bgcolor="#FFFFFF" valign="top"> <p align="justify" style="margin-left: 10px; margin-right: 10px"><font face="Verdana" size="1"> 
                <br>
                </font><b><font face="Verdana" size="4">Promoting inclusive 
			growth</font></b><font face="Verdana" size="1"><br>
			<b>Rajat Gupta a keynote speaker at the 2008 Leaders in Dubai 
			Business Forums speaks to OER about world economics, global currency 
			and corporate social responsibility </b><br>
			<br>
			<img border="0" src="60min.jpg" align="left" hspace="8" vspace="6">Rajat Gupta served as the Managing Director of McKinsey and Company 
			...
			Strategy, Style and Avoiding Disasters Worldwide.”<br>
			<br>
			<b>What are the top three challenges facing the world today (could 
			be political, economic, cultural and social)?<br>
			</b>Today’s greatest economic challenge is the need to strengthen 
			...
			middle-class standard of living.<br>
			<br>
			...
			for concerted action to confront climate change.<br>
			<br>
			<b>How will the current state of global inflation shape the world 
			economy? What can be done to alleviate rising food prices?<br>
			</b>The world’s central banks now face the complex task of 
			...
			world’s poorest.<br>
			<br>
			<b>What are your thoughts on a unified world currency? Is this a 
			viable project? <br>
			</b>The success of the Euro has shown that currency unions can 
			...
			<br>
			<b>What are the primary reasons behind the soaring prices of 
			commodities? What are the long-term effects of this?<br>
			</b>The intensifying demand for raw materials in fast-developing 
			...
			an ever-more-populous and ever-hungrier world.<br>
			<br>
			<b>How much does corporate social responsibility have to do with the 
			...
			get away with bad environmental practices?<br>
			</b>Corporations have a civic duty to society, in addition to their 
			...
			creative, sustainable solutions emerge from the public debate.<br>
			<br>
			<b>How can companies grow despite weak economy?<br>
			</b>Managing an enterprise through an economic downturn is one of 
			...
			<font face="Verdana" size="1">OER is a media partner of Leaders in 
			Dubai forum.</font><br>
              </i>
              </p>
              </td>
