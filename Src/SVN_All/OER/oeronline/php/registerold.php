        ...
        <tr>
          <td width="77%" height="1" valign="top">
           ...
           <td width="100%" colspan="2"><b><font face="Verdana" size="1">You Are Successfully&nbsp;
            ...
            <tr>
              <td width="25%" align="left"><font face="Verdana" size="2">Telephone</font></td>
              <td width="75%"><font face="Verdana" size="2" color="#FF0000"><? echo $HTTP_SESSION_VARS["tel"]; ?></font></td>
            </tr>
            <tr>
              <td width="25%" align="left"><font face="Verdana" size="2">GSM</font></td>
              <td width="75%"><font face="Verdana" size="2" color="#FF0000"><? echo $HTTP_SESSION_VARS["gsm"]; ?></font></td>
            </tr>
            <tr>
