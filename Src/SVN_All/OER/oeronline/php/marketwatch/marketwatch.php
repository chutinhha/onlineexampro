...
<? include("../../inc/menu_marketwatch.htm");
?></td>
  </tr>
  <tr>
    <td width="100%" height="21">
            ...
            <div align="center">
              <table border="0" cellpadding="0" style="border-collapse: collapse" width="95%" id="table1">
                <tr>
                  ...
                  <font face="Times New Roman" size="2"><b><big><big>
                  ::</big></big></b>
 </font><big><b><big><font face="Verdana" size="2">Marketwatch</font></big></b></big></font></td>
                </tr>
                <tr>
                  <td>&nbsp;</td>
                </tr>
                  ...
                  <table border="0" cellpadding="0" style="border-collapse: collapse" width="100%" id="table2">
                    <tr>
                      ...
                      <table border="0" cellpadding="0" style="border-collapse: collapse" width="100%" id="table4">
                        <tr>
                          <td> <tr>
                          <td><? include("../../inc/local_news1.htm");?></td>
                        </tr>
                        <tr>
                          <td><? include("../../inc/local_news2.htm");?></td>
                        </tr></td>
                        </tr>
                      </table>
