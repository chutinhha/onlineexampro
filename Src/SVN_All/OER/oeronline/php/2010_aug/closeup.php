          ...
          <tr>
            ...
            <div align="left">
				<table border="0" style="border-collapse: collapse" width="237" cellpadding="0">
					<tr>
						<td width="30" bgcolor="#FF0000" height="30" style="border-left-style: solid; border-left-width: 1px; border-right-width: 1px; border-top-width: 1px; border-bottom-style: solid; border-bottom-width: 1px; padding-left: 4px; padding-right: 4px; padding-top: 1px; padding-bottom: 1px" bordercolor="#000000">&nbsp;</td>
						<td valign="bottom" style="border-bottom-style: solid; border-bottom-width: 1px; padding-left: 4px; padding-right: 4px; padding-top: 1px; padding-bottom: 1px" bordercolor="#FF0000" width="201">
            <p align="left" style="margin-left: 5px">
			<a name="top"><b><font face="Verdana" size="1">CLOSE UP</font></b></a></td>
					</tr>
				</table>
			</div>
			</td>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
	          <tr> 
				...
				<p align="justify" style="margin-left: 10px; margin-right: 10px" dir="ltr"> 
                    ...
                    <font face="Verdana" size="4" color="#C00000">Broadbasing 
					its choices</font></b></p>
						<p align="justify" style="margin-left: 10px; margin-right: 10px" dir="ltr">
						<b><font face="Verdana" size="2">The new GCC roadmap of 
						cooperating with new regional blocs will enhance its 
						economic choices and rectify the traditional trade 
						imbalance that these countries have suffered from</font></b><p align="justify" style="margin-left: 10px; margin-right: 10px" dir="ltr"> 
				<img border="0" src="images/aug_Jasim-Husain.jpg" style="border: 1px solid #C0C0C0; " align="right" hspace="10" width="100" height="114"><font face="Verdana" size="1">Bahrain 
					...
					socio-economic and socio-political landscape. <br>
					<br>
					</font><font face="Verdana" size="2"><b>Reaching out<br>
					...
					Switzerland, Norway, Iceland and Liechtenstein. <br>
					<br>
					</font><font face="Verdana" size="2"><b>Reviving talks with 
					EU <br>
					</b></font><font face="Verdana" size="1"><br>
					...
					eventual aim of signing an FTA between the two blocs.<br>
					<br>
					...
					conditions prior to singing a deal with the GCC. <br>
					<br>
					</font><font face="Verdana" size="2"><b>Addressing EU 
					demands<br>
					</b></font><font face="Verdana" size="1"><br>
					Yet, <b>EU countries insist on addressing issues related to 
					human rights and democracy as preconditions for signing a 
					trade accord with GCC states. </b>In addition they also 
					...
					Romania, Poland, Hungary and the Czech Republic.<br>
					<br>
					...
					countries, in turn the largest economic bloc in the world.<br>
					<br>
	          ...
	          <tr> 
                <td height="18">                
				<p align="right" style="margin-left: 10px; margin-right: 10px" dir="ltr">
				<i><b><font face="Verdana" size="1" color="#C00000">The author 
				is an eminent economist and Member of Parliment, Bahrain&nbsp; 
				<br>
				DR JASIM HUSAIN ALI</font></b></i></td>
	</tr>
	          <tr> 
                <td height="18">                </td>
	</tr>
