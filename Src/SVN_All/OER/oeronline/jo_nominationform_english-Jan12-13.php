...
<ul>
<li><label for="YourName">Your Name:</label><span style="color:#F00;">*</span>&nbsp;<input type="text" size="30" tabindex="1"class="itext" name="name" value="<?php echo $_SESSION['form_val']['name']; ?>"></li>
<li>
