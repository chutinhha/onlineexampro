...
{
    public partial class MissionAccountBankDeposit : Form
    {
        public MissionAccountBankDeposit()
        {
            InitializeComponent();
        }

        private void MissionAccountBankDeposit_Load(object sender, EventArgs e)
        {
